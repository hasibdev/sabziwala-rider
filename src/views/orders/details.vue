<template>
   <app-layout title="Order Details" abletoBack>
      ...
      <div v-if="order">
         ...
         <ion-button v-if="order.status != 'delivered'" expand="block" class="ion-margin-top" @click="completeOrder">Complete Order</ion-button>
      </div>
   </app-layout>
</template>
...
export default defineComponent({
   ...
   methods: {
      async completeOrder() {
         try {
            await this.axios.patch(`/orders/${this.$route.params.id}/update`, { status: 'delivered' })
